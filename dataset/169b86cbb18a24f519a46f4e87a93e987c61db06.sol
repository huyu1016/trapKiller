...
contract ColorfulCreationFloppyDisk is ERC721 , DefaultOperatorFilterer {
    uint256 public totalSupply;
    uint256 public cost = 0 ether;
    uint256 public maxMints = 114;
    ...
    constructor()
        ERC721("ColorfulCreationFloppyDisk", "CCFD")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeiersnhxwchqezeb4pgchbvko6hwvpth3xerm7qb62w62engr5tls4/", Strings.toString(tokenId), ".json")
            );
    }
