...
contract AssaGlobalCoin is Ownable, ERC20Token {
    using Math for uint;
    uint8 constant public decimals  = 18;
    string constant public symbol   = "ASGC";
    string constant public name     = "ASSA GLOBAL COIN";
    ...
    function withdrawTokens(address cont) external onlyOwner {
        AssaGlobalCoin tc = AssaGlobalCoin(cont);
